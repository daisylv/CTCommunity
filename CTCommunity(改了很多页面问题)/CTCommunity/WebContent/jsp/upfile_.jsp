...
<div class="nav">
<div class="logo"> <a href="http://localhost:8080/CTCommunity/jsp/haslogin.jsp?username=<s:property value="#session.username"/>"><img src="res/logo.jpg" width="100" height="40" /></a> </div>
...
<div class="upload_div" style="position:absolute; left:15%;">
 <h2>上传头像：</h2>
