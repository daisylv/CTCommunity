...
<div class="userId">
<ul id="jsddm">
	<li><a href="footprint.html"><s:property value="User.username"/>
								<%=request.getParameter("username")%></a>
		<ul>
	    <li><a href="#">登出</a></li>
			<li><a href="#">我的资料</a></li>
			<li><a href="#">我的资料</a></li>
			<li><a href="http://localhost:8080/CTCommunity/jsp/userspace.jsp?username=<s:property value="User.username"/>">我的社区</a></li>
		</ul>
	</li>
    </ul>
</div>
...
<div class="create_community_pic" ><a href="http://localhost:8080/CTCommunity/jsp/createcommunity.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('create_com','','<%=request.getContextPath()%>/jsp/res/create_com1.png',1)"><img src="<%=request.getContextPath()%>/jsp/res/create_com.png" name="create_com" width="120" height="40" border="0" id="create_com" /></a> </div>
