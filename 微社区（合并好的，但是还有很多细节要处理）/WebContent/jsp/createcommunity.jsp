...
<table width="620" height="206" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
		<s:form action="Addcommunity" namespace="/com/action" method="post">
		   
			<s:textfield label="社区名" name="Community.communityName"></s:textfield> 
			<s:textfield label="社区介绍" name="Community.communityIntro"></s:textfield>
			<s:select label="社区类型"  name="Community.communityType" list="@com.action.Hello@typelist"
			headerKey="-1" headerValue="请选择社区类型"
			emptyOption="false"
			/>
