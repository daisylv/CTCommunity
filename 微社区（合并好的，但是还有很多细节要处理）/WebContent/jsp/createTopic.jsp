...
<body>
	...
	<div class="nav">
		<div class="logo">
			<a href="home.html"><img src="res/logo.jpg" width="100"
				height="40" /></a>
		</div>
		...
		<div id="search">
			<table id="__01" width="181" height="40" border="0" cellpadding="0"
				cellspacing="0">
				<tr>
					<td colspan="3"><img src="images/search2_01.png" width="180"
						height="8" alt=""></td>
					<td><img src="" width="1" height="8" alt=""></td>
				</tr>
				<tr>
					<td rowspan="2"><img src="images/search2_02.png" width="13"
						height="27" alt=""></td>
					...
					<td><a href="#"><img src="images/search2_04.png"
							width="29" height="25" alt=""></a></td>
					<td></td>
				</tr>
				<tr>
					<td rowspan="2"><img src="images/search2_05.png" width="138"
						height="7" alt=""></td>
					<td rowspan="2"><img src="images/search2_06.png" width="29"
						height="7" alt=""></td>
					<td><img src="" width="1" height="2" alt=""></td>
				</tr>
				<tr>
					<td><img src="images/search2_07.png" width="13" height="5"
						alt=""></td>
