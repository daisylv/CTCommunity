...
<div id="catelog" >
<ul class="tags">
<!-- <li><a href="http://localhost:8080/CTCommunity?type=运动" >运动类</a></li>
<li><a href="http://localhost:8080/CTCommunity?type=动画片" >动画类</a></li> -->
<s:iterator id = "it" value="@com.action.Hello@typelist" status="st">

	<li><a href="http://localhost:8080/CTCommunity?type=<s:property value="it"/>" ><s:property value="it"/></a></li>
</s:iterator>
<!-- <li><a href="#" >分类1</a></li>
<li><a href="#" >分类1</a></li>
<li><a href="#" >分类1</a></li>
...
<s:iterator value="communitylist">
 			<s:if test='communityType == #request.type'> 	<!-- if test='communityType == #parameters.type[0]'> -->
<li >
